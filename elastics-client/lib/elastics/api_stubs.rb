module Elastics
  module ApiStubs
    ...
    #
    #  Usage:
    #  Elastics.put_store :index => index,  # required
    #                     :type  => type,   # required
    #                     :id    => id      # required
    #
    def self.put_store(*vars)
      ## this is a stub, used for reference
      super
    end
    ...
    #
    #  Usage:
    #  Elastics.remove :index => index,  # required
    #                  :type  => type,   # required
    #                  :id    => id      # required
    #
    def self.remove(*vars)
      ## this is a stub, used for reference
      super
    end
    ...
    #
    #  Usage:
    #  Elastics.multi_get :index => index,  # required
    #                     :type  => type,   # required
    #                     :ids   => ids     # required
    #
    def self.multi_get(*vars)
      ## this is a stub, used for reference
      super
    end
    ...
    #
    #  Usage:
    #  Elastics.mlt :index => index,  # required
    #               :type  => type,   # required
    #               :id    => id      # required
    #
    def self.mlt(*vars)
    ...
    #
    #  Usage:
    #  Elastics.create_index :index              => index,  # required
    #                        :number_of_shards   => 5,
    #                        :number_of_replicas => 1
    #
    def self.create_index(*vars)
      ## this is a stub, used for reference
      super
    end
    ...
    #
    #  Usage:
    #  Elastics.index_exists :index => index  # required
    #
    def self.index_exists(*vars)
      ## this is a stub, used for reference
      super
    end
    ...
    #
    #  Usage:
    #  Elastics.put_mapping :index      => index,      # required
    #                       :type       => type,       # required
    #                       :properties => properties  # required
    #
    def self.put_mapping(*vars)
      ## this is a stub, used for reference
      super
    end
    ...
    #
    #  Usage:
    #  Elastics.type_exists :index => index,  # required
    #                       :type  => type    # required
    #
    def self.type_exists(*vars)
      ## this is a stub, used for reference
      super
    end
    ...
    #
    #  Usage:
    #  Elastics.put_index_settings :index => "_all"
    #
    def self.put_index_settings(*vars)
      ## this is a stub, used for reference
      super
    end
